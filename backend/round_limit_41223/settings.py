"""
Django settings for round_limit_41223 project.
...
ROOT_URLCONF = 'round_limit_41223.urls'
...
WSGI_APPLICATION = 'round_limit_41223.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_limit_41223 API",
    "DESCRIPTION": "API documentation for round_limit_41223 App",
    "VERSION": "v1",
}
